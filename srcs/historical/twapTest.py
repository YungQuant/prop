...
aapl = GoogleIntradayQuote("AAPL").close
twapArr = []; tempArr = []; sArr = [];
for i in range(len(aapl)):
    tempArr.append(aapl[i])
    if i > 31:
        twapArr.append(twap(tempArr, 30))
        sArr.append(SMAn(tempArr, 30))

plot3(aapl[32:], twapArr, sArr)
