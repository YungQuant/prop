...
def get_data(currency):
    ...
    filename = f'../../kucoin_data/OMX_order_book.txt'
    ...
    for i in range(len(keys)):
        ...
        #
        #
        # buys.append(data[keys[i]['buys']])
        # sells.append(data[keys[i]['sells']])
        #
        # data['buys'] = buys
        # data['sells'] = sells
...
def anal(currencies, logfile, live=False, n=0):
    ...
    #recent_orders = getRecentOrders(currencies)
...
logfile = f'../../output/histMarketAnal1_{starttime}.txt'
